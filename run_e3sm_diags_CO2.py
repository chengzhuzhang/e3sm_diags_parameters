...
param.test_data_path = '/p/user_pub/e3sm/zhang40/e3sm_cmip6_xmls/v1_water_cycle/1pctCO2/r1i1p1f1'
param.test_name = 'e3sm_v1_1pctCO2_abrupt4CO2'
...
#param.results_dir = os.path.join(prefix, 'area_mean_co2_r1')
...
ts_param.ref_names = ['r1i1p1f1']   #This setting plot model data only
ts_param.start_yr = '0001'
ts_param.end_yr = '0150'
